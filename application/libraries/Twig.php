...
class Twig
{
	...
	protected function createTwig()
	{
		...
		$mafunction = new Twig_SimpleFunction("__", function($args){
			return _($args);
		});
		$twig->addFunction($mafunction);

		$urlFunction = new Twig_SimpleFunction("url", function($args){
			$CI =& get_instance();
    		$CI->load->model('Page');
    		return $CI->Page->getUrl($args);
		});
